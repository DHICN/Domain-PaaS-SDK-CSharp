...
namespace DHICN.PAAS.SDK.ModelInformation.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QueryJunctionDto :  IEquatable<QueryJunctionDto>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="QueryJunctionDto" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class QueryJunctionDto {\n");
        ...
        {
            return this.Equals(input as QueryJunctionDto);
        }

        /// <summary>
        /// Returns true if QueryJunctionDto instances are equal
        /// </summary>
        /// <param name="input">Instance of QueryJunctionDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QueryJunctionDto input)
        {
            if (input == null)
                return false;
