...
namespace DHICN.PAAS.SDK.DocumentManager.Api
{
    ...
    public partial class HealthApi : IHealthApi
    {
        ...
        /// <returns></returns>
        public HealthApi(DHICN.PAAS.SDK.DocumentManager.Client.Configuration configuration)
        {
        ...
        public HealthApi(DHICN.PAAS.SDK.DocumentManager.Client.ISynchronousClient client,DHICN.PAAS.SDK.DocumentManager.Client.IAsynchronousClient asyncClient, DHICN.PAAS.SDK.DocumentManager.Client.IReadableConfiguration configuration)
        {
        ...
        {
             DHICN.PAAS.SDK.DocumentManager.Client.ApiResponse<Result<string>> localVarResponse = HealthGetWithHttpInfo();
        ...
        /// <exception cref="DHICN.PAAS.SDK.DocumentManager.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of string</returns>
        public DHICN.PAAS.SDK.DocumentManager.Client.ApiResponse<Result< string >> HealthGetWithHttpInfo ()
        {
        ...
        {
             DHICN.PAAS.SDK.DocumentManager.Client.ApiResponse<Result<string>> localVarResponse = await HealthGetAsyncWithHttpInfo();
             return localVarResponse.Data;
        ...
        /// <exception cref="DHICN.PAAS.SDK.DocumentManager.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse (string)</returns>
        public async System.Threading.Tasks.Task<DHICN.PAAS.SDK.DocumentManager.Client.ApiResponse<Result<string>>> HealthGetAsyncWithHttpInfo ()
        {
