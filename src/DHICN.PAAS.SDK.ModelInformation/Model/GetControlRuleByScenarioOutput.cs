...
{
    /// <summary>
    /// GetControlRuleByScenarioOutput
    /// </summary>
    [DataContract]
    public partial class GetControlRuleByScenarioOutput :  IEquatable<GetControlRuleByScenarioOutput>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetControlRuleByScenarioOutput" /> class.
        /// </summary>
        ...
        public GetControlRuleByScenarioOutput(List<CsPump> csPumps = default(List<CsPump>), List<CsValve> csValves = default(List<CsValve>), List<RiverPump> riverPumps = default(List<RiverPump>), List<RiverGate> riverGates = default(List<RiverGate>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetControlRuleByScenarioOutput {\n");
        ...
        {
            return this.Equals(input as GetControlRuleByScenarioOutput);
        }

        /// <summary>
        /// Returns true if GetControlRuleByScenarioOutput instances are equal
        /// </summary>
        /// <param name="input">Instance of GetControlRuleByScenarioOutput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetControlRuleByScenarioOutput input)
        {
            if (input == null)
                return false;
