...
namespace DHICN.PAAS.SDK.ScenarioCompute.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DhiDssScenarioComputeWdDtosCreateWdScheduleScenarioInput :  IEquatable<DhiDssScenarioComputeWdDtosCreateWdScheduleScenarioInput>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DhiDssScenarioComputeWdDtosCreateWdScheduleScenarioInput" /> class.
        /// </summary>
        ...
        /// <param name="parentScenarioId">父方案,如果是基于其他方案的派生方案，则需要填写此字段.</param>
        public DhiDssScenarioComputeWdDtosCreateWdScheduleScenarioInput(string newScenarioName = default(string), string description = default(string), DateTime currentTime = default(DateTime), DateTime startTime = default(DateTime), DateTime endTime = default(DateTime), string subType = default(string), Guid? parentScenarioId = default(Guid?))
        {
        ...
        /// </summary>
        /// <value>父方案,如果是基于其他方案的派生方案，则需要填写此字段</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DhiDssScenarioComputeWdDtosCreateWdScheduleScenarioInput {\n");
        ...
        {
            return this.Equals(input as DhiDssScenarioComputeWdDtosCreateWdScheduleScenarioInput);
        }

        /// <summary>
        /// Returns true if DhiDssScenarioComputeWdDtosCreateWdScheduleScenarioInput instances are equal
        /// </summary>
        /// <param name="input">Instance of DhiDssScenarioComputeWdDtosCreateWdScheduleScenarioInput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DhiDssScenarioComputeWdDtosCreateWdScheduleScenarioInput input)
        {
            if (input == null)
                return false;
