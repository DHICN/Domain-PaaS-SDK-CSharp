...
namespace DHICN.PAAS.SDK.ModelInformation.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateTankDto :  IEquatable<UpdateTankDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateTankDto" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as UpdateTankDto);
        }

        /// <summary>
        /// Returns true if UpdateTankDto instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateTankDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateTankDto input)
        {
            if (input == null)
                return false;
