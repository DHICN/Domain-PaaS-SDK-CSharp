...
{
    /// <summary>
    /// QueryOrganizationOutput
    /// </summary>
    [DataContract]
    public partial class QueryOrganizationOutput :  IEquatable<QueryOrganizationOutput>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QueryOrganizationOutput" /> class.
        /// </summary>
        ...
        public QueryOrganizationOutput(Guid id = default(Guid), string name = default(string), string levelCode = default(string), string parentLevelCode = default(string), bool isHasChildren = default(bool), List<QueryOrganizationOutput> children = default(List<QueryOrganizationOutput>))
        {
            this.Id = id;
            this.Name = name;
        ...
        public List<QueryOrganizationOutput> Children { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class QueryOrganizationOutput {\n");
        ...
        {
            return this.Equals(input as QueryOrganizationOutput);
        }

        /// <summary>
        /// Returns true if QueryOrganizationOutput instances are equal
        /// </summary>
        /// <param name="input">Instance of QueryOrganizationOutput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QueryOrganizationOutput input)
        {
            if (input == null)
                return false;
