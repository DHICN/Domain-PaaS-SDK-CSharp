...
namespace DHICN.PAAS.SDK.ModelInformation.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QueryPipeDto :  IEquatable<QueryPipeDto>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="QueryPipeDto" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as QueryPipeDto);
        }

        /// <summary>
        /// Returns true if QueryPipeDto instances are equal
        /// </summary>
        /// <param name="input">Instance of QueryPipeDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QueryPipeDto input)
        {
            if (input == null)
                return false;
