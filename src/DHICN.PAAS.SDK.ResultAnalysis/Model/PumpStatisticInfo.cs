...
namespace DHICN.PAAS.SDK.ResultAnalysis.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PumpStatisticInfo :  IEquatable<PumpStatisticInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PumpStatisticInfo" /> class.
        /// </summary>
        /// <param name="dt">时间 time.</param>
        /// <param name="pumpInfos">泵站信息详情  pump details.</param>
        public PumpStatisticInfo(string dt = default(string), List<PumpInfo> pumpInfos = default(List<PumpInfo>))
        {
            this.Dt = dt;
        ...
        /// 泵站信息详情  pump details
        /// </summary>
        /// <value>泵站信息详情  pump details</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PumpStatisticInfo {\n");
        ...
        {
            return this.Equals(input as PumpStatisticInfo);
        }

        /// <summary>
        /// Returns true if PumpStatisticInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of PumpStatisticInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PumpStatisticInfo input)
        {
            if (input == null)
                return false;
