...
{
    /// <summary>
    /// StatisticTimeItemDto
    /// </summary>
    [DataContract]
    public partial class StatisticTimeItemDto :  IEquatable<StatisticTimeItemDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StatisticTimeItemDto" /> class.
        /// </summary>
        /// <param name="maxValue">maxValue.</param>
        /// <param name="minValue">minValue.</param>
        /// <param name="avgValue">avgValue.</param>
        public StatisticTimeItemDto(double maxValue = default(double), double minValue = default(double), double avgValue = default(double))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StatisticTimeItemDto {\n");
        ...
        {
            return this.Equals(input as StatisticTimeItemDto);
        }

        /// <summary>
        /// Returns true if StatisticTimeItemDto instances are equal
        /// </summary>
        /// <param name="input">Instance of StatisticTimeItemDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StatisticTimeItemDto input)
        {
            if (input == null)
                return false;
