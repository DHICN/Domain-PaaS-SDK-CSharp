...
namespace DHICN.PAAS.SDK.ModelInformation.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AddDemandDto :  IEquatable<AddDemandDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddDemandDto" /> class.
        /// </summary>
        ...
        public AddDemandDto(string junctionID = default(string), double demand = default(double), string category = default(string), double coefficient = default(double), string patternID = default(string), string description = default(string))
        {
        ...
        {
            return this.Equals(input as AddDemandDto);
        }

        /// <summary>
        /// Returns true if AddDemandDto instances are equal
        /// </summary>
        /// <param name="input">Instance of AddDemandDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddDemandDto input)
        {
            if (input == null)
                return false;
