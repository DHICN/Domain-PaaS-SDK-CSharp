...
{
    /// <summary>
    /// QueryUsersWithOrganziationOutput
    /// </summary>
    [DataContract]
    public partial class QueryUsersWithOrganziationOutput :  IEquatable<QueryUsersWithOrganziationOutput>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="QueryUsersWithOrganziationOutput" /> class.
        /// </summary>
        ...
        public QueryUsersWithOrganziationOutput(Guid id = default(Guid), StatusEnum? status = default(StatusEnum?), string userName = default(string), string surname = default(string), string email = default(string), string department = default(string), string extraProperties = default(string), DateTime creationTime = default(DateTime), Guid? tenantId = default(Guid?), List<GuidStringKeyValue> userRoles = default(List<GuidStringKeyValue>), bool isTrialUser = default(bool), DateTime? trialDeadline = default(DateTime?), string phoneNumber = default(string), List<OrganizationEntity> organizations = default(List<OrganizationEntity>))
        {
            this.Id = id;
            this.Status = status;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class QueryUsersWithOrganziationOutput {\n");
        ...
        {
            return this.Equals(input as QueryUsersWithOrganziationOutput);
        }

        /// <summary>
        /// Returns true if QueryUsersWithOrganziationOutput instances are equal
        /// </summary>
        /// <param name="input">Instance of QueryUsersWithOrganziationOutput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QueryUsersWithOrganziationOutput input)
        {
            if (input == null)
                return false;
