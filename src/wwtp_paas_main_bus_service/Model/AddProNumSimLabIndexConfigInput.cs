...
namespace wwtp_paas_main_bus_service.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AddProNumSimLabIndexConfigInput :  IEquatable<AddProNumSimLabIndexConfigInput>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddProNumSimLabIndexConfigInput" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AddProNumSimLabIndexConfigInput() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AddProNumSimLabIndexConfigInput" /> class.
        /// </summary>
        ...
        public AddProNumSimLabIndexConfigInput(string code = default(string), ScenarioModelNodeDto modelNodes = default(ScenarioModelNodeDto), string outputFile = default(string), string remRateFile = default(string))
        {
            // to ensure "code" is required (not null)
            this.Code = code ?? throw new ArgumentNullException("code is a required property for AddProNumSimLabIndexConfigInput and cannot be null");
            // to ensure "modelNodes" is required (not null)
            this.ModelNodes = modelNodes ?? throw new ArgumentNullException("modelNodes is a required property for AddProNumSimLabIndexConfigInput and cannot be null");
            // to ensure "outputFile" is required (not null)
            this.OutputFile = outputFile ?? throw new ArgumentNullException("outputFile is a required property for AddProNumSimLabIndexConfigInput and cannot be null");
            // to ensure "remRateFile" is required (not null)
            this.RemRateFile = remRateFile ?? throw new ArgumentNullException("remRateFile is a required property for AddProNumSimLabIndexConfigInput and cannot be null");
        }
        ...
        {
            return this.Equals(input as AddProNumSimLabIndexConfigInput);
        }

        /// <summary>
        /// Returns true if AddProNumSimLabIndexConfigInput instances are equal
        /// </summary>
        /// <param name="input">Instance of AddProNumSimLabIndexConfigInput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddProNumSimLabIndexConfigInput input)
        {
            if (input == null)
                return false;
