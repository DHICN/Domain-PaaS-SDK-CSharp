...
namespace DHICN.PAAS.SDK.WWTP.MainBus.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DosingStatisticMonthlysInOut :  IEquatable<DosingStatisticMonthlysInOut>, IValidatableObject
    {
        /// <summary>
        /// 药剂投加类别
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DosingStatisticMonthlysInOut" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as DosingStatisticMonthlysInOut);
        }

        /// <summary>
        /// Returns true if DosingStatisticMonthlysInOut instances are equal
        /// </summary>
        /// <param name="input">Instance of DosingStatisticMonthlysInOut to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DosingStatisticMonthlysInOut input)
        {
            if (input == null)
                return false;
