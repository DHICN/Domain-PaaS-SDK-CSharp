...
namespace DHICN.PAAS.SDK.ModelInformation.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateJunctionDto :  IEquatable<UpdateJunctionDto>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateJunctionDto" /> class.
        /// </summary>
        ...
        /// <param name="id">节点ID junction id.</param>
        public UpdateJunctionDto(string muid = default(string), int nodeType = default(int), double elevation = default(double), double surfaceElevation = default(double), string zoneID = default(string), double initChemicalConcentration = default(double), double initSourcePercentage = default(double), double initWaterAge = default(double), string description = default(string), string dataSource = default(string), string assetName = default(string), double x = default(double), double y = default(double), OperateEnum? operate = default(OperateEnum?), Guid id = default(Guid))
        {
            this.Muid = muid;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateJunctionDto {\n");
        ...
        {
            return this.Equals(input as UpdateJunctionDto);
        }

        /// <summary>
        /// Returns true if UpdateJunctionDto instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateJunctionDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateJunctionDto input)
        {
            if (input == null)
                return false;
