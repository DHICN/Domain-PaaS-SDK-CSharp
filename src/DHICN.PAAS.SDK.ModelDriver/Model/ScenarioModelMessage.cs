...
namespace DHICN.PAAS.SDK.ModelDriver.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ScenarioModelMessage :  IEquatable<ScenarioModelMessage>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ScenarioModelMessage" /> class.
        /// </summary>
        /// <param name="id">Id 与持久化在数据库中的Id一致,即queueId.</param>
        ...
        public ScenarioModelMessage(Guid id = default(Guid), string projectName = default(string), Guid tenantId = default(Guid), Guid scenarioId = default(Guid), string modelType = default(string), int priority = default(int), string modelInfo = default(string))
        {
            this.Id = id;
        ...
        /// </summary>
        /// <value>Id 与持久化在数据库中的Id一致,即queueId</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ScenarioModelMessage {\n");
        ...
        {
            return this.Equals(input as ScenarioModelMessage);
        }

        /// <summary>
        /// Returns true if ScenarioModelMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of ScenarioModelMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ScenarioModelMessage input)
        {
            if (input == null)
                return false;
