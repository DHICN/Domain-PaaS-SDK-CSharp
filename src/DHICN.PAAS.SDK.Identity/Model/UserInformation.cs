...
namespace DHICN.PAAS.SDK.Identity.Model
{
    ...
    public partial class UserInformation :  IEquatable<UserInformation>, IValidatableObject
    {
        ...
        public UserInformation(Guid id = default(Guid), string userName = default(string), string surName = default(string), string phoneNumber = default(string), string email = default(string), List<RoleInfo> roleInfos = default(List<RoleInfo>))
        {
            this.Id = id;
