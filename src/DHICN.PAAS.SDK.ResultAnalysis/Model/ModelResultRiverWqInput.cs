...
namespace DHICN.PAAS.SDK.ResultAnalysis.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ModelResultRiverWqInput :  IEquatable<ModelResultRiverWqInput>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ModelResultRiverWqInput" /> class.
        /// </summary>
        /// <param name="scenarioId">方案id scenario id.</param>
        /// <param name="wqItem">水质 water quality.</param>
        /// <param name="frequency">频率 frequency.</param>
        /// <param name="startTime">开始时间 start time.</param>
        /// <param name="endTime">结束时间 end time.</param>
        public ModelResultRiverWqInput(string scenarioId = default(string), string wqItem = default(string), int frequency = default(int), DateTime startTime = default(DateTime), DateTime endTime = default(DateTime))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ModelResultRiverWqInput {\n");
        ...
        {
            return this.Equals(input as ModelResultRiverWqInput);
        }

        /// <summary>
        /// Returns true if ModelResultRiverWqInput instances are equal
        /// </summary>
        /// <param name="input">Instance of ModelResultRiverWqInput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ModelResultRiverWqInput input)
        {
            if (input == null)
                return false;
