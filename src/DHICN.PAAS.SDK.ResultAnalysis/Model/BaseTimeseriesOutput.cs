...
namespace DHICN.PAAS.SDK.ResultAnalysis.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BaseTimeseriesOutput :  IEquatable<BaseTimeseriesOutput>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BaseTimeseriesOutput" /> class.
        /// </summary>
        /// <param name="t">时刻列表 all the time steps, in string with timezone.</param>
        /// <param name="v">时刻对应的数值列表 value of each time step.</param>
        public BaseTimeseriesOutput(List<string> t = default(List<string>), List<double> v = default(List<double>))
        {
            this.T = t;
            this.V = v;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BaseTimeseriesOutput {\n");
        ...
        {
            return this.Equals(input as BaseTimeseriesOutput);
        }

        /// <summary>
        /// Returns true if BaseTimeseriesOutput instances are equal
        /// </summary>
        /// <param name="input">Instance of BaseTimeseriesOutput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BaseTimeseriesOutput input)
        {
            if (input == null)
                return false;
