...
namespace DHICN.PAAS.SDK.ModelInformation.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AddValveDto :  IEquatable<AddValveDto>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AddValveDto" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as AddValveDto);
        }

        /// <summary>
        /// Returns true if AddValveDto instances are equal
        /// </summary>
        /// <param name="input">Instance of AddValveDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddValveDto input)
        {
            if (input == null)
                return false;
