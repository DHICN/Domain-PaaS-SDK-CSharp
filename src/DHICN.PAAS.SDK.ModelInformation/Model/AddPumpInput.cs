...
namespace DHICN.PAAS.SDK.ModelInformation.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AddPumpInput :  IEquatable<AddPumpInput>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddPumpInput" /> class.
        /// </summary>
        /// <param name="scenarioId">方案ID scenario id.</param>
        /// <param name="pumps">新增泵站列表 pumps to be added.</param>
        public AddPumpInput(string scenarioId = default(string), List<AddPumpDto> pumps = default(List<AddPumpDto>))
        {
        ...
        /// </summary>
        /// <value>新增泵站列表 pumps to be added</value>
        [DataMember(Name="pumps", EmitDefaultValue=true)]
        public List<AddPumpDto> Pumps { get; set; }
        ...
        {
            return this.Equals(input as AddPumpInput);
        }

        /// <summary>
        /// Returns true if AddPumpInput instances are equal
        /// </summary>
        /// <param name="input">Instance of AddPumpInput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddPumpInput input)
        {
            if (input == null)
                return false;
