...
namespace DHICN.PAAS.SDK.Message.Center.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MessageTypeOutput :  IEquatable<MessageTypeOutput>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MessageTypeOutput" /> class.
        /// </summary>
        ...
        public MessageTypeOutput(Guid id = default(Guid), string msgType = default(string), string showName = default(string), int order = default(int))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MessageTypeOutput {\n");
        ...
        {
            return this.Equals(input as MessageTypeOutput);
        }

        /// <summary>
        /// Returns true if MessageTypeOutput instances are equal
        /// </summary>
        /// <param name="input">Instance of MessageTypeOutput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MessageTypeOutput input)
        {
            if (input == null)
                return false;
