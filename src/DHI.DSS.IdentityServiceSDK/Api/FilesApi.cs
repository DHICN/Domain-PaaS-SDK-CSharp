...
namespace DHI.DSS.IdentityServiceSDK.Api
{
    ...
    public partial class FilesApi : IFilesApi
    {
        ...
        /// <returns></returns>
        public FilesApi(DHI.DSS.IdentityServiceSDK.Client.Configuration configuration)
        {
        ...
        public FilesApi(DHI.DSS.IdentityServiceSDK.Client.ISynchronousClient client,DHI.DSS.IdentityServiceSDK.Client.IAsynchronousClient asyncClient, DHI.DSS.IdentityServiceSDK.Client.IReadableConfiguration configuration)
        {
        ...
        {
             DHI.DSS.IdentityServiceSDK.Client.ApiResponse<Result<string>> localVarResponse = ApiAppFilesUploadPostWithHttpInfo();
        ...
        /// <exception cref="DHI.DSS.IdentityServiceSDK.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of string</returns>
        public DHI.DSS.IdentityServiceSDK.Client.ApiResponse<Result< string >> ApiAppFilesUploadPostWithHttpInfo ()
        {
        ...
        {
             DHI.DSS.IdentityServiceSDK.Client.ApiResponse<Result<string>> localVarResponse = await ApiAppFilesUploadPostAsyncWithHttpInfo();
             return localVarResponse.Data;
        ...
        /// <exception cref="DHI.DSS.IdentityServiceSDK.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse (string)</returns>
        public async System.Threading.Tasks.Task<DHI.DSS.IdentityServiceSDK.Client.ApiResponse<Result<string>>> ApiAppFilesUploadPostAsyncWithHttpInfo ()
        {
