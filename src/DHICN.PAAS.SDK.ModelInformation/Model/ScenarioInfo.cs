...
namespace DHICN.PAAS.SDK.ModelInformation.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ScenarioInfo :  IEquatable<ScenarioInfo>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="id">方案ID scenario Id.</param>
        ...
        public ScenarioInfo(string name = default(string), string minIOBucket = default(string), string minIOPath = default(string), string tenantId = default(string), string version = default(string), string description = default(string), string state = default(string), int autoAmend = default(int), int onlineFirst = default(int), int published = default(int), int calculated = default(int), int _checked = default(int), int modified = default(int), int autoCalculate = default(int), string createTime = default(string), string endTime = default(string), string startTime = default(string), string currentTime = default(string), string projectFile = default(string), string relativeFolder = default(string), int enabled = default(int), int readOnly = default(int), Guid? inheritedScenario = default(Guid?), Guid? id = default(Guid?), string scenarioCode = default(string), string scenarioName = default(string), string modelType = default(string), string modelSubType = default(string), int template = default(int))
        {
            this.Name = name;
        ...
        [DataMember(Name="_checked", EmitDefaultValue=false)]
        ...
        [DataMember(Name="inheritedScenario", EmitDefaultValue=true)]
        ...
        {
            return this.Equals(input as ScenarioInfo);
        }

        /// <summary>
        /// Returns true if ScenarioInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of ScenarioInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ScenarioInfo input)
        {
            if (input == null)
                return false;
