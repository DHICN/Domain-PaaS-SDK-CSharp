...
namespace DHICN.PAAS.SDK.ModelInformation.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AddControlTsDto :  IEquatable<AddControlTsDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddControlTsDto" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AddControlTsDto() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AddControlTsDto" /> class.
        /// </summary>
        ...
        public AddControlTsDto(Guid? indicatorId = default(Guid?), string modelId = default(string), List<int> t = default(List<int>), List<double> v = default(List<double>))
        {
            // to ensure "modelId" is required (not null)
            this.ModelId = modelId ?? throw new ArgumentNullException("modelId is a required property for AddControlTsDto and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AddControlTsDto {\n");
        ...
        {
            return this.Equals(input as AddControlTsDto);
        }

        /// <summary>
        /// Returns true if AddControlTsDto instances are equal
        /// </summary>
        /// <param name="input">Instance of AddControlTsDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddControlTsDto input)
        {
            if (input == null)
                return false;
