...
namespace DHI.DSS.IdentityServiceSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateRolePermissionsInput :  IEquatable<UpdateRolePermissionsInput>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateRolePermissionsInput" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateRolePermissionsInput() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateRolePermissionsInput" /> class.
        /// </summary>
        ...
        public UpdateRolePermissionsInput(Guid? tenantId = default(Guid?), List<string> roles = default(List<string>), string regular = default(string), bool isCarryAuth = default(bool), string serviceKey = default(string), int priority = default(int), Guid id = default(Guid))
        {
            // to ensure "regular" is required (not null)
            this.Regular = regular ?? throw new ArgumentNullException("regular is a required property for UpdateRolePermissionsInput and cannot be null");
        ...
        /// </summary>
        /// <value>角色权限ID role permission id</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateRolePermissionsInput {\n");
        ...
        {
            return this.Equals(input as UpdateRolePermissionsInput);
        }

        /// <summary>
        /// Returns true if UpdateRolePermissionsInput instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateRolePermissionsInput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateRolePermissionsInput input)
        {
            if (input == null)
                return false;
