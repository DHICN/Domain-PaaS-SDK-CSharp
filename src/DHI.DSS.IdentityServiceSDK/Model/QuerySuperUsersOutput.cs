...
{
    /// <summary>
    /// QuerySuperUsersOutput
    /// </summary>
    [DataContract]
    public partial class QuerySuperUsersOutput :  IEquatable<QuerySuperUsersOutput>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="QuerySuperUsersOutput" /> class.
        /// </summary>
        ...
        /// <param name="tenants">租户信息列表 tenants.</param>
        public QuerySuperUsersOutput(Guid id = default(Guid), StatusEnum? status = default(StatusEnum?), string userName = default(string), string surname = default(string), string email = default(string), string department = default(string), string extraProperties = default(string), DateTime creationTime = default(DateTime), Guid? tenantId = default(Guid?), List<GuidStringKeyValue> userRoles = default(List<GuidStringKeyValue>), bool isTrialUser = default(bool), DateTime? trialDeadline = default(DateTime?), string phoneNumber = default(string), List<TenantBelongSystemDto> tenants = default(List<TenantBelongSystemDto>))
        {
            this.Id = id;
            this.Status = status;
        ...
        /// 租户信息列表 tenants
        /// </summary>
        /// <value>租户信息列表 tenants</value>
        [DataMember(Name="tenants", EmitDefaultValue=true)]
        public List<TenantBelongSystemDto> Tenants { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class QuerySuperUsersOutput {\n");
        ...
        {
            return this.Equals(input as QuerySuperUsersOutput);
        }

        /// <summary>
        /// Returns true if QuerySuperUsersOutput instances are equal
        /// </summary>
        /// <param name="input">Instance of QuerySuperUsersOutput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QuerySuperUsersOutput input)
        {
            if (input == null)
                return false;
