...
namespace DHICN.PAAS.SDK.ScenarioManager.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateScenarioByGroupPara2 :  IEquatable<CreateScenarioByGroupPara2>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateScenarioByGroupPara2" /> class.
        /// </summary>
        /// <param name="parentScenarioId">父方案的ID parent scenario&#39;s Id.</param>
        ...
        public CreateScenarioByGroupPara2(string parentScenarioId = default(string), string groupId = default(string), string newScenarioName = default(string), DateTime startTime = default(DateTime), DateTime endTime = default(DateTime), string subType = default(string), string description = default(string))
        {
        ...
        /// </summary>
        /// <value>父方案的ID parent scenario&#39;s Id</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateScenarioByGroupPara2 {\n");
        ...
        {
            return this.Equals(input as CreateScenarioByGroupPara2);
        }

        /// <summary>
        /// Returns true if CreateScenarioByGroupPara2 instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateScenarioByGroupPara2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateScenarioByGroupPara2 input)
        {
            if (input == null)
                return false;
