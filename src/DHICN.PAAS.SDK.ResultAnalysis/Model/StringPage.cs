...
namespace DHICN.PAAS.SDK.ResultAnalysis.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class StringPage :  IEquatable<StringPage>, IValidatableObject
    {
        /// <summary>
        ...
        public StringPage(int pageIndex = default(int), int pageSize = default(int), List<string> list = default(List<string>), long totalCount = default(long))
        {
        ...
        {
            return this.Equals(input as StringPage);
        }

        /// <summary>
        /// Returns true if StringPage instances are equal
        /// </summary>
        /// <param name="input">Instance of StringPage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StringPage input)
        {
            if (input == null)
                return false;
