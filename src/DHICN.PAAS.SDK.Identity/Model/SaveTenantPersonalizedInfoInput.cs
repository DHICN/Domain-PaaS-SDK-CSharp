...
namespace DHICN.PAAS.SDK.Identity.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SaveTenantPersonalizedInfoInput :  IEquatable<SaveTenantPersonalizedInfoInput>, IValidatableObject
    {
        /// <summary>
        /// 封面类型 cover type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SaveTenantPersonalizedInfoInput" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SaveTenantPersonalizedInfoInput() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SaveTenantPersonalizedInfoInput" /> class.
        /// </summary>
        ...
        public SaveTenantPersonalizedInfoInput(string title = default(string), string icon = default(string), string logo = default(string), CoverTypeEnum? coverType = default(CoverTypeEnum?), string cover = default(string))
        {
            // to ensure "title" is required (not null)
            this.Title = title ?? throw new ArgumentNullException("title is a required property for SaveTenantPersonalizedInfoInput and cannot be null");
            // to ensure "icon" is required (not null)
            this.Icon = icon ?? throw new ArgumentNullException("icon is a required property for SaveTenantPersonalizedInfoInput and cannot be null");
            // to ensure "logo" is required (not null)
            this.Logo = logo ?? throw new ArgumentNullException("logo is a required property for SaveTenantPersonalizedInfoInput and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SaveTenantPersonalizedInfoInput {\n");
        ...
        {
            return this.Equals(input as SaveTenantPersonalizedInfoInput);
        }

        /// <summary>
        /// Returns true if SaveTenantPersonalizedInfoInput instances are equal
        /// </summary>
        /// <param name="input">Instance of SaveTenantPersonalizedInfoInput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SaveTenantPersonalizedInfoInput input)
        {
            if (input == null)
                return false;
