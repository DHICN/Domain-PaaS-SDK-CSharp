...
namespace DHICN.PAAS.SDK.ModelInformation.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateManualScenarioInput :  IEquatable<CreateManualScenarioInput>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateManualScenarioInput" /> class.
        /// </summary>
        /// <param name="newScenarioName">方案名称 scenario name.</param>
        /// <param name="currentTime">预报时刻 current time.</param>
        /// <param name="startTime">开始时刻 start time.</param>
        /// <param name="endTime">结束时刻 end time.</param>
        /// <param name="description">方案描述 scenario description.</param>
        public CreateManualScenarioInput(string newScenarioName = default(string), DateTime currentTime = default(DateTime), DateTime startTime = default(DateTime), DateTime endTime = default(DateTime), string description = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateManualScenarioInput {\n");
        ...
        {
            return this.Equals(input as CreateManualScenarioInput);
        }

        /// <summary>
        /// Returns true if CreateManualScenarioInput instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateManualScenarioInput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateManualScenarioInput input)
        {
            if (input == null)
                return false;
