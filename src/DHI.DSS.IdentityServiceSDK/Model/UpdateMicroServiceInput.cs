...
namespace DHI.DSS.IdentityServiceSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateMicroServiceInput :  IEquatable<UpdateMicroServiceInput>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateMicroServiceInput" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateMicroServiceInput() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateMicroServiceInput" /> class.
        /// </summary>
        ...
        public UpdateMicroServiceInput(string serviceKey = default(string), string serviceName = default(string), string developVoice = default(string), bool isGatewayAuth = default(bool), string managerName = default(string), string remarks = default(string), Guid id = default(Guid))
        {
            // to ensure "serviceKey" is required (not null)
            this.ServiceKey = serviceKey ?? throw new ArgumentNullException("serviceKey is a required property for UpdateMicroServiceInput and cannot be null");
            // to ensure "serviceName" is required (not null)
            this.ServiceName = serviceName ?? throw new ArgumentNullException("serviceName is a required property for UpdateMicroServiceInput and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateMicroServiceInput {\n");
        ...
        {
            return this.Equals(input as UpdateMicroServiceInput);
        }

        /// <summary>
        /// Returns true if UpdateMicroServiceInput instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateMicroServiceInput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateMicroServiceInput input)
        {
            if (input == null)
                return false;
