...
namespace DHI.DSS.IdentityServiceSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateUserInput :  IEquatable<UpdateUserInput>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateUserInput" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateUserInput() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateUserInput" /> class.
        /// </summary>
        ...
        /// <param name="id">用户ID user id (required).</param>
        public UpdateUserInput(string userName = default(string), string surname = default(string), List<Guid> roles = default(List<Guid>), string phoneNumber = default(string), string department = default(string), StatusEnum status = default(StatusEnum), bool isTrialUser = default(bool), int trialDays = default(int), string email = default(string), Guid id = default(Guid))
        {
            // to ensure "userName" is required (not null)
            this.UserName = userName ?? throw new ArgumentNullException("userName is a required property for UpdateUserInput and cannot be null");
            this.Status = status;
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateUserInput {\n");
        ...
        {
            return this.Equals(input as UpdateUserInput);
        }

        /// <summary>
        /// Returns true if UpdateUserInput instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateUserInput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateUserInput input)
        {
            if (input == null)
                return false;
