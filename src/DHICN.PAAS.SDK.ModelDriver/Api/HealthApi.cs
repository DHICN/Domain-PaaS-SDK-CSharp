...
namespace DHICN.PAAS.SDK.ModelDriver.Api
{
    ...
    public partial class HealthApi : IHealthApi
    {
        ...
        /// <returns></returns>
        public HealthApi(DHICN.PAAS.SDK.ModelDriver.Client.Configuration configuration)
        {
        ...
        public HealthApi(DHICN.PAAS.SDK.ModelDriver.Client.ISynchronousClient client,DHICN.PAAS.SDK.ModelDriver.Client.IAsynchronousClient asyncClient, DHICN.PAAS.SDK.ModelDriver.Client.IReadableConfiguration configuration)
        {
        ...
        {
             DHICN.PAAS.SDK.ModelDriver.Client.ApiResponse<Result<string>> localVarResponse = HealthGetWithHttpInfo();
        ...
        /// <exception cref="DHICN.PAAS.SDK.ModelDriver.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of string</returns>
        public DHICN.PAAS.SDK.ModelDriver.Client.ApiResponse<Result< string >> HealthGetWithHttpInfo ()
        {
        ...
        {
             DHICN.PAAS.SDK.ModelDriver.Client.ApiResponse<Result<string>> localVarResponse = await HealthGetAsyncWithHttpInfo();
             return localVarResponse.Data;
        ...
        /// <exception cref="DHICN.PAAS.SDK.ModelDriver.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse (string)</returns>
        public async System.Threading.Tasks.Task<DHICN.PAAS.SDK.ModelDriver.Client.ApiResponse<Result<string>>> HealthGetAsyncWithHttpInfo ()
        {
