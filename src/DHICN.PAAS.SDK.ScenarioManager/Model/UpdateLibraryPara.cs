...
namespace DHICN.PAAS.SDK.ScenarioManager.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateLibraryPara :  IEquatable<UpdateLibraryPara>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateLibraryPara" /> class.
        /// </summary>
        /// <param name="id">库的ID library&#39;s Id.</param>
        ...
        /// <param name="_readonly">0代表可读写，1代表只读 0 for not readonly, 1 for readonly and can&#39;t be updated.</param>
        ...
        public UpdateLibraryPara(Guid id = default(Guid), Guid scenariogroup = default(Guid), string name = default(string), int type = default(int), int businessType = default(int), int _readonly = default(int), int bindTemplate = default(int), int bindType = default(int), int bindBusinessType = default(int), int? enableMultiTemplate = default(int?), string description = default(string))
        {
            this.Id = id;
        ...
        /// </summary>
        /// <value>0代表可读写，1代表只读 0 for not readonly, 1 for readonly and can&#39;t be updated</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateLibraryPara {\n");
        ...
        {
            return this.Equals(input as UpdateLibraryPara);
        }

        /// <summary>
        /// Returns true if UpdateLibraryPara instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateLibraryPara to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateLibraryPara input)
        {
            if (input == null)
                return false;
