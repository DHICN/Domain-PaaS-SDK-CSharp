...
namespace wwtp_paas_main_bus_service.Model
{
    ...
    public partial class PointValue :  IEquatable<PointValue>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="pointCode">在线点位 online point code.</param>
        /// <param name="value">数值 value.</param>
        public PointValue(string pointCode = default(string), double value = default(double))
        {
        ...
        /// </summary>
        /// <value>在线点位 online point code</value>
