...
namespace DHICN.PAAS.SDK.ModelInformation.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AddPumpDto :  IEquatable<AddPumpDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddPumpDto" /> class.
        /// </summary>
        ...
        public AddPumpDto(string muid = default(string), string fromNode = default(string), string toNode = default(string), int pumpType = default(int), double speed = default(double), string patternID = default(string), double constantPower = default(double), string zoneID = default(string), string description = default(string), string dataSource = default(string), string assetName = default(string), double fromX = default(double), double fromY = default(double), double toX = default(double), double toY = default(double))
        {
            this.Muid = muid;
        ...
        {
            return this.Equals(input as AddPumpDto);
        }

        /// <summary>
        /// Returns true if AddPumpDto instances are equal
        /// </summary>
        /// <param name="input">Instance of AddPumpDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddPumpDto input)
        {
            if (input == null)
                return false;
