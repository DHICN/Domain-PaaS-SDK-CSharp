...
namespace DHI.DSS.IdentityServiceSDK.Api
{
    ...
    public partial class ConnectApi : IConnectApi
    {
        ...
        /// <returns></returns>
        public ConnectApi(DHI.DSS.IdentityServiceSDK.Client.Configuration configuration)
        {
        ...
        public ConnectApi(DHI.DSS.IdentityServiceSDK.Client.ISynchronousClient client,DHI.DSS.IdentityServiceSDK.Client.IAsynchronousClient asyncClient, DHI.DSS.IdentityServiceSDK.Client.IReadableConfiguration configuration)
        {
        ...
        {
             DHI.DSS.IdentityServiceSDK.Client.ApiResponse<Result<bool>> localVarResponse = ApiV1ConnectAuthByMobilePostWithHttpInfo(authByQrCodeInput);
        ...
        /// <param name="authByQrCodeInput"> (optional)</param>
        /// <returns>ApiResponse of bool</returns>
        public DHI.DSS.IdentityServiceSDK.Client.ApiResponse<Result< bool >> ApiV1ConnectAuthByMobilePostWithHttpInfo (AuthByQrCodeInput authByQrCodeInput = default(AuthByQrCodeInput))
        {
        ...
        {
             DHI.DSS.IdentityServiceSDK.Client.ApiResponse<Result<bool>> localVarResponse = await ApiV1ConnectAuthByMobilePostAsyncWithHttpInfo(authByQrCodeInput);
             return localVarResponse.Data;
        ...
        /// <param name="authByQrCodeInput"> (optional)</param>
        /// <returns>Task of ApiResponse (bool)</returns>
        public async System.Threading.Tasks.Task<DHI.DSS.IdentityServiceSDK.Client.ApiResponse<Result<bool>>> ApiV1ConnectAuthByMobilePostAsyncWithHttpInfo (AuthByQrCodeInput authByQrCodeInput = default(AuthByQrCodeInput))
        {
        ...
        {
             DHI.DSS.IdentityServiceSDK.Client.ApiResponse<Result<AuthResultOutput>> localVarResponse = ApiV1ConnectAuthResultGetWithHttpInfo(key);
             return localVarResponse.Data;
        }
        ...
        /// <param name="key"> (optional)</param>
        /// <returns>ApiResponse of AuthResultOutput</returns>
        public DHI.DSS.IdentityServiceSDK.Client.ApiResponse<Result< AuthResultOutput >> ApiV1ConnectAuthResultGetWithHttpInfo (string key = default(string))
        {
            DHI.DSS.IdentityServiceSDK.Client.RequestOptions localVarRequestOptions = new DHI.DSS.IdentityServiceSDK.Client.RequestOptions();
            ...
            if (key != null)
            {
                localVarRequestOptions.QueryParameters.Add(DHI.DSS.IdentityServiceSDK.Client.ClientUtils.ParameterToMultiMap("", "key", key));
            }
        ...
        {
             DHI.DSS.IdentityServiceSDK.Client.ApiResponse<Result<AuthResultOutput>> localVarResponse = await ApiV1ConnectAuthResultGetAsyncWithHttpInfo(key);
             return localVarResponse.Data;
        ...
        /// <param name="key"> (optional)</param>
        /// <returns>Task of ApiResponse (AuthResultOutput)</returns>
        public async System.Threading.Tasks.Task<DHI.DSS.IdentityServiceSDK.Client.ApiResponse<Result<AuthResultOutput>>> ApiV1ConnectAuthResultGetAsyncWithHttpInfo (string key = default(string))
        {
        ...
        /// <exception cref="DHI.DSS.IdentityServiceSDK.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of Object(void)</returns>
        public DHI.DSS.IdentityServiceSDK.Client.ApiResponse<Result<Object>> ApiV1ConnectQrcodeGetWithHttpInfo ()
        {
            DHI.DSS.IdentityServiceSDK.Client.RequestOptions localVarRequestOptions = new DHI.DSS.IdentityServiceSDK.Client.RequestOptions();
        ...
        /// <exception cref="DHI.DSS.IdentityServiceSDK.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<DHI.DSS.IdentityServiceSDK.Client.ApiResponse<Result<Object>>> ApiV1ConnectQrcodeGetAsyncWithHttpInfo ()
        {
        ...
        {
             DHI.DSS.IdentityServiceSDK.Client.ApiResponse<Result<InlineResponse200>> localVarResponse = ConnectTokenPostWithHttpInfo(tenantId, clientId, grantType, clientSecret, username, password);
             return localVarResponse.Data;
        }
        ...
        /// <param name="password"> (optional)</param>
        /// <returns>ApiResponse of InlineResponse200</returns>
        public DHI.DSS.IdentityServiceSDK.Client.ApiResponse<Result< InlineResponse200 >> ConnectTokenPostWithHttpInfo (string tenantId = default(string), string clientId = default(string), string grantType = default(string), string clientSecret = default(string), string username = default(string), string password = default(string))
        {
            DHI.DSS.IdentityServiceSDK.Client.RequestOptions localVarRequestOptions = new DHI.DSS.IdentityServiceSDK.Client.RequestOptions();
            ...
            if (tenantId != null)
            {
                localVarRequestOptions.HeaderParameters.Add("TenantId", DHI.DSS.IdentityServiceSDK.Client.ClientUtils.ParameterToString(tenantId)); // header parameter
            }
            if (clientId != null)
            {
                localVarRequestOptions.FormParameters.Add("client_id", DHI.DSS.IdentityServiceSDK.Client.ClientUtils.ParameterToString(clientId)); // form parameter
            }
            if (grantType != null)
            {
                localVarRequestOptions.FormParameters.Add("grant_type", DHI.DSS.IdentityServiceSDK.Client.ClientUtils.ParameterToString(grantType)); // form parameter
            }
            if (clientSecret != null)
            {
                localVarRequestOptions.FormParameters.Add("client_secret", DHI.DSS.IdentityServiceSDK.Client.ClientUtils.ParameterToString(clientSecret)); // form parameter
            }
            if (username != null)
            {
                localVarRequestOptions.FormParameters.Add("username", DHI.DSS.IdentityServiceSDK.Client.ClientUtils.ParameterToString(username)); // form parameter
            }
            if (password != null)
            {
                localVarRequestOptions.FormParameters.Add("password", DHI.DSS.IdentityServiceSDK.Client.ClientUtils.ParameterToString(password)); // form parameter
            }
        ...
        {
             DHI.DSS.IdentityServiceSDK.Client.ApiResponse<Result<InlineResponse200>> localVarResponse = await ConnectTokenPostAsyncWithHttpInfo(tenantId, clientId, grantType, clientSecret, username, password);
             return localVarResponse.Data;
