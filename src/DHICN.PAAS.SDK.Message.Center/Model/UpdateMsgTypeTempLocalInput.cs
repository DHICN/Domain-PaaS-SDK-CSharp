...
{
    /// <summary>
    /// UpdateMsgTypeTempLocalInput
    /// </summary>
    [DataContract]
    public partial class UpdateMsgTypeTempLocalInput :  IEquatable<UpdateMsgTypeTempLocalInput>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateMsgTypeTempLocalInput" /> class.
        /// </summary>
        ...
        public UpdateMsgTypeTempLocalInput(Guid id = default(Guid), string msgType = default(string), string language = default(string), MsgTemplateObj msgTemplate = default(MsgTemplateObj))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateMsgTypeTempLocalInput {\n");
        ...
        {
            return this.Equals(input as UpdateMsgTypeTempLocalInput);
        }

        /// <summary>
        /// Returns true if UpdateMsgTypeTempLocalInput instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateMsgTypeTempLocalInput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateMsgTypeTempLocalInput input)
        {
            if (input == null)
                return false;
