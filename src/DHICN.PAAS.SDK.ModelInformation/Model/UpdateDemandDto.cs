...
namespace DHICN.PAAS.SDK.ModelInformation.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateDemandDto :  IEquatable<UpdateDemandDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateDemandDto" /> class.
        /// </summary>
        ...
        public UpdateDemandDto(string junctionID = default(string), double demand = default(double), string category = default(string), double coefficient = default(double), string patternID = default(string), string description = default(string), Guid id = default(Guid))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateDemandDto {\n");
        ...
        {
            return this.Equals(input as UpdateDemandDto);
        }

        /// <summary>
        /// Returns true if UpdateDemandDto instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateDemandDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateDemandDto input)
        {
            if (input == null)
                return false;
