...
namespace DHICN.PAAS.SDK.ModelInformation.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ControlTsDto :  IEquatable<ControlTsDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ControlTsDto" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ControlTsDto() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ControlTsDto" /> class.
        /// </summary>
        /// <param name="indicatorId">设备指标id，可以为空 device indicator id, can be null.</param>
        /// <param name="modelId">模型点位Id(pump、valve、pipe) model muid of pump, valve or pipe (required).</param>
        /// <param name="t">相对时间列表，单位秒 relative times in second.</param>
        /// <param name="v">数值列表 values.</param>
        /// <param name="id">控制规则时序数据ID control time-series data id.</param>
        public ControlTsDto(Guid? indicatorId = default(Guid?), string modelId = default(string), List<int> t = default(List<int>), List<double> v = default(List<double>), Guid id = default(Guid))
        {
            // to ensure "modelId" is required (not null)
            this.ModelId = modelId ?? throw new ArgumentNullException("modelId is a required property for ControlTsDto and cannot be null");
        ...
        /// </summary>
        /// <value>模型点位Id(pump、valve、pipe) model muid of pump, valve or pipe</value>
        ...
        /// </summary>
        /// <value>控制规则时序数据ID control time-series data id</value>
        ...
        {
            return this.Equals(input as ControlTsDto);
        }

        /// <summary>
        /// Returns true if ControlTsDto instances are equal
        /// </summary>
        /// <param name="input">Instance of ControlTsDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ControlTsDto input)
        {
            if (input == null)
                return false;
