...
namespace DHICN.PAAS.SDK.ModelInformation.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PatternTsDto :  IEquatable<PatternTsDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PatternTsDto" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PatternTsDto() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PatternTsDto" /> class.
        /// </summary>
        /// <param name="indicatorId">设备指标id，可以为空 device indicator id, can be null.</param>
        /// <param name="modelId">模型中的模式ID patter muid (required).</param>
        /// <param name="patternType">模式类型 pattern type.</param>
        /// <param name="t">相对时间列表，单位秒 relative times in second.</param>
        /// <param name="v">数值列表 values.</param>
        /// <param name="id">模式时序数据ID pattern time-series data id.</param>
        public PatternTsDto(Guid? indicatorId = default(Guid?), string modelId = default(string), string patternType = default(string), List<int> t = default(List<int>), List<double> v = default(List<double>), Guid id = default(Guid))
        {
            // to ensure "modelId" is required (not null)
            this.ModelId = modelId ?? throw new ArgumentNullException("modelId is a required property for PatternTsDto and cannot be null");
        ...
        /// </summary>
        /// <value>模型中的模式ID patter muid</value>
        ...
        /// </summary>
        /// <value>模式时序数据ID pattern time-series data id</value>
        ...
        {
            return this.Equals(input as PatternTsDto);
        }

        /// <summary>
        /// Returns true if PatternTsDto instances are equal
        /// </summary>
        /// <param name="input">Instance of PatternTsDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PatternTsDto input)
        {
            if (input == null)
                return false;
