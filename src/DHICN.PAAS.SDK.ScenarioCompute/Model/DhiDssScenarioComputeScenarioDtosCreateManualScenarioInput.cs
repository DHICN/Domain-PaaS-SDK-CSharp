...
namespace DHICN.PAAS.SDK.ScenarioCompute.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DhiDssScenarioComputeScenarioDtosCreateManualScenarioInput :  IEquatable<DhiDssScenarioComputeScenarioDtosCreateManualScenarioInput>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DhiDssScenarioComputeScenarioDtosCreateManualScenarioInput" /> class.
        /// </summary>
        ...
        public DhiDssScenarioComputeScenarioDtosCreateManualScenarioInput(string newScenarioName = default(string), DateTime currentTime = default(DateTime), DateTime startTime = default(DateTime), DateTime endTime = default(DateTime), string description = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DhiDssScenarioComputeScenarioDtosCreateManualScenarioInput {\n");
        ...
        {
            return this.Equals(input as DhiDssScenarioComputeScenarioDtosCreateManualScenarioInput);
        }

        /// <summary>
        /// Returns true if DhiDssScenarioComputeScenarioDtosCreateManualScenarioInput instances are equal
        /// </summary>
        /// <param name="input">Instance of DhiDssScenarioComputeScenarioDtosCreateManualScenarioInput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DhiDssScenarioComputeScenarioDtosCreateManualScenarioInput input)
        {
            if (input == null)
                return false;
