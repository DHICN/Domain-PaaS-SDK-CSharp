...
namespace DHICN.PAAS.SDK.Message.Center.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AddMessageTypeInput :  IEquatable<AddMessageTypeInput>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddMessageTypeInput" /> class.
        /// </summary>
        ...
        public AddMessageTypeInput(string msgType = default(string), string showName = default(string), int order = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AddMessageTypeInput {\n");
        ...
        {
            return this.Equals(input as AddMessageTypeInput);
        }

        /// <summary>
        /// Returns true if AddMessageTypeInput instances are equal
        /// </summary>
        /// <param name="input">Instance of AddMessageTypeInput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddMessageTypeInput input)
        {
            if (input == null)
                return false;
