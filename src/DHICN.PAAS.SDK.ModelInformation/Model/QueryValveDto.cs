...
namespace DHICN.PAAS.SDK.ModelInformation.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QueryValveDto :  IEquatable<QueryValveDto>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="QueryValveDto" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as QueryValveDto);
        }

        /// <summary>
        /// Returns true if QueryValveDto instances are equal
        /// </summary>
        /// <param name="input">Instance of QueryValveDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QueryValveDto input)
        {
            if (input == null)
                return false;
