...
namespace DHICN.PAAS.SDK.ModelInformation.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QueryPumpDto :  IEquatable<QueryPumpDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QueryPumpDto" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as QueryPumpDto);
        }

        /// <summary>
        /// Returns true if QueryPumpDto instances are equal
        /// </summary>
        /// <param name="input">Instance of QueryPumpDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QueryPumpDto input)
        {
            if (input == null)
                return false;
